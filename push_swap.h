...
void	sort_4(t_stack **a, t_stack **b, int fd, int first, int second, int third, int fourth);
void	sort_5(t_stack **a, t_stack **b, int fd, int first, int second, int third, int fourth, int fifth);
